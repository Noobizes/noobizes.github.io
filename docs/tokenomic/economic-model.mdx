...
You can access the detailed operation of the commission system in our [white paper](https://noobizes.com/Noobizes_Whitepaper.pdf)
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
  <img src="/img/com-legends.png" width="90%" />
</div>
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
  <div
    style={{
  ...
  >
    <img src="/img/com-challenge.png" width="40%" />
    <img src="/img/com-tournament.png" width="40%" />
  </div>
  <div
    style={{
      display: 'flex',
  ...
  >
    <img src="/img/com-secondary.png" width="40%" />
    <img src="/img/com-withdrawal.png" width="40%" />
  </div>
  <div
    style={{
      display: 'flex',
  ...
  >
    <img src="/img/com-marketing.png" width="80%" />
  </div>
</div>
