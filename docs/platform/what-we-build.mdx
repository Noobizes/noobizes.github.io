...
By using the blockchain we can stores all the results of any events on Noobizes, to create a reliable and immutable history of players profile activity.
