...
We aim to build a **decentralized governance system** that **allows gamers** to **become actors of the ecosystem**

- By **participating in the platform's evolution choices**
- By **voting** on the **next game that will be add**
- By **voting** on the **next tournament** (game, prize pool ...)

We think that **a good Esport platform must be community oriented** for a **continuous gaming innovations**.
